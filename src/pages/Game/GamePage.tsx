...
import { useDeployStore } from "../Deploy/store/useDeployStore";
import {
  StyledPlayground,
  StyledResultWrapper,
  StyledWrapper,
...
export const GamePage = () => {
  ...
  const renderModal = (
    ...
    >
      <StyledResultWrapper>{resultText}</StyledResultWrapper>
    </Modal>
  );
